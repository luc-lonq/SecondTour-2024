...
router.route('/fixtures').get(async (req, res) => {
  ...
  await db.query(`insert into matiere (id_matiere, id_serie, nom, temps_preparation, temps_preparation_tiers_temps, temps_passage, temps_passage_tiers_temps, loge)
  ...
  await db.query(`insert into parametres (id_parametre, max_jour, heure_debut_matin, heure_fin_matin, heure_debut_apres_midi,
  ...
  values (1,'admin@ac-poitiers.fr','$p5k2$3e8$AfpOzesj$.KoGR.raCRkA3gne.aZrF1bQobRfdSIH',true);`).catch(e => {
    res.status(500).send(e)
  })
